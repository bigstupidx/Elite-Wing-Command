...
{
	[SerializeField] AllyTanks allyTanks;
	...
	void Start()
	{
		...
		TargetPrefab = allyTanks.UnitPrefab;
		MaxInGame = allyTanks.MaxInGame;
		TotalRespawns = allyTanks.TotalRespawns;
		SquadSpawn = allyTanks.SquadSpawn;
		SquadSpawnSize = allyTanks.SquadSpawnSize;
	}

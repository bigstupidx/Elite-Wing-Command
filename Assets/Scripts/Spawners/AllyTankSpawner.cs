...
public class AllyTankSpawner : TargetSpawner
{
	...
	void Start()
	{
		...
		TargetPrefab = missionManager.allyTanks[unitArrayNumber].UnitPrefab;
		MaxInGame = missionManager.allyTanks[unitArrayNumber].MaxInGame;
		TotalRespawns = missionManager.allyTanks[unitArrayNumber].TotalRespawns;
		SquadSpawn = missionManager.allyTanks[unitArrayNumber].SquadSpawn;
		SquadSpawnSize = missionManager.allyTanks[unitArrayNumber].SquadSpawnSize;
	}

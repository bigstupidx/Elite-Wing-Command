...
public class EncryptedPlayerPrefs 
{
	...
	private static string privateKey = "J021RrkhKyUiGQfWJ6OXyIQVy601h5Gb";
	
	// Add some values to this array before using EncryptedPlayerPrefs
	public static string[] keys = { "JkExiiuDs6", "fP65KB6H7s", "hfmhf3E284", "bYWhKo18Cu", "wtw9Qv63ZA", "PB43UuCS5Q" };
